...
function servicios() {
    fetch(
        'https://preview.contentful.com/spaces/c5dlmdkopz9z/environments/master/entries?access_token=3bdEfZhrdgVYs42k4gTdBAOu4JiZvTSNHfZKwYeEYuk&content_type=desafioM4Servicios'
    )
        .then((res) => res.json())
        .then((data) => {
